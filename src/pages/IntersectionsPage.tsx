...
import { Plus, Edit2, Trash2, MapPin, X, Save, FolderPlus, Check, Folder, Clock, Award, ChevronDown, ChevronUp, Lightbulb, BarChart3, Cpu, Eye } from 'lucide-react';
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {intersection.signalTiming ? (
                            <div className="text-xs text-green-400 mt-2 flex items-center gap-1">
                              ...
                              已配时 · {intersection.signalTiming.cycleDuration}秒周期
                            </div>
                          ) : (
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <button
                            ...
                            onClick={(e) => {
                              e.stopPropagation();
                              navigate(`/intersections/${intersection.id}/signal-timing`);
                            }}
                            ...
                            title={intersection.signalTiming ? '编辑配时' : '录入配时'}
                          >
